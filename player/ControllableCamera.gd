...
@onready var gun_raycast: RayCast3D = $GimbalH/GimbalV/Camera3D/GunRaycast
@onready var crosshair: Crosshair = $Crosshair
@onready var gimbal_h: Node3D = $GimbalH
@onready var distant_point_front: Node3D = $GimbalH/GimbalV/Camera3D/DistantPointFront
